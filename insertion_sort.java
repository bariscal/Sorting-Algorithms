...
public class insertion_sort {
	...
	public static void main(String[] args) {
		...
		System.out.println("Test Case 1: " + Arrays.toString(insertion_sort(test_array_1)));
		System.out.println("Test Case 2: " + Arrays.toString(insertion_sort(test_array_2)));
		System.out.println("Test Case 3: " + Arrays.toString(insertion_sort(test_array_3)));
		System.out.println("Test Case 4: " + Arrays.toString(insertion_sort(test_array_4)));
		System.out.println("Test Case 5: " + Arrays.toString(insertion_sort(test_array_5)));
		System.out.println("Test Case 6: " + Arrays.toString(insertion_sort(test_array_6)));
	}
